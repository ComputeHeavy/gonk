...
class TestSqliteStateAPIInterface(test_utils.GonkTest):
    ...
    #     schemas_all(self, name: None|str =None)

    # def test_events_by_object(self):
    #     events_by_object(self, uuid_: uuid.UUID, version: int)

    # def test_events_by_annotation(self):
    #     events_by_annotation(self, uuid_: uuid.UUID, version: int)

    # def test_events_all(self):
    #     events_all(self, after: None|uuid.UUID = None)

    # def test_annotations_all(self):
    #     annotations_all(self, 
    #         uuid_: None|uuid.UUID = None, after: None|uuid.UUID = None)

    # def test_annotations_by_object(self):
    #     annotations_by_object(self, object_identifier: events.Identifier)

    # def test_annotations_by_status(self):
    #     annotations_by_status(self, status: str, after: None|uuid.UUID = None)

    # def test_annotation(self):
    #     annotation(self, uuid_: uuid.UUID, version: int)
    ...
    #     objects_by_annotation(self, annotation_uuid: uuid.UUID)

    # def test_objects_by_status(self):
    #     objects_by_status(self, status: str, after: None|uuid.UUID = None)

    # def test_object(self):
    #     object(self, uuid_: uuid.UUID, version: int)
